...
public class TUIFormPanel2 extends TUIPanel implements DocumentListener, FilesSelectionListener {
	...
	public void setEnabledAceptAction(boolean enable) {
		Action act = (Action) getClientProperty("aceptAction");
		if (act != null) {
	...
	/**
	 * add the input field for this {@link TUIFormPanel2} instace. this component don.t set the name of the component.
	...
	protected void addInputComponent(String field, JComponent cmp, boolean required, boolean enable) {
		...
		cmp.putClientProperty("myLable", jl);
