 ...
 *
 * Messages can be directed here from different sources. Each source can have its messages displayed in a different
 * color.
 *
...
public class MessageConsole {
	...
	class ConsoleOutputStream extends ByteArrayOutputStream {
		...
		/*
		 * Override this method to intercept the output text. Each line of text output will actually involve invoking
		 * this method twice:
		 *
		 * a) for the actual text message b) for the newLine string
		 *
		 * The message will be treated differently depending on whether the line will be appended or inserted into the
		 * Document
		 */
		public void flush() {
