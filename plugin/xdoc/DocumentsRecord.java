...
public class DocumentsRecord extends AbstractRecordDataInput implements PropertyChangeListener {
	...
	public DocumentsRecord(Record r, boolean newr) {
		...
		fileJB.setToolTipText(TStringUtils.getString("ttxd_coname"));
		...
		jtp.add(TStringUtils.getString("xdoc.cfg.general"), jpa);
		jpa = getQRCodePanel();
		TUIUtils.setEmptyBorder(jpa);
		jtp.add(TStringUtils.getString("xdoc.cfg.dsign"), jpa);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == fileJB) {
			Object[] options = { TStringUtils.getString("xdoc.selectnew"), TStringUtils.getString("xdoc.selectcancel") };
			int o = JOptionPane.showOptionDialog(null, TStringUtils.getString("xdoc.msg06"),
					TStringUtils.getString("xdoc.editd"), JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE,
